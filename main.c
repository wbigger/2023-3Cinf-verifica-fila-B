...
int main()
{
    ...
    /** Test funzione calcola_area_triangolo */
    {
        ...
        printf("L'area del triangolo di base %0.3f e altezza %0.3f e': %0.4f m/s\n", b,h, area);
    ...
    /** Test funzione calcola_arco_circonferenza*/
    {
        ...
        printf("La lunghezza dell'ipotenusa con cateti %0.3f e %0.3F e': %0.4f m/s\n", c1, c2, ip);
